...
public class Varasto {
    ...
    public Varasto(double tilavuus, double alkuSaldo) { // kuormitetaan
        if (tilavuus > 0.0) {
            luoVarasto(tilavuus, alkuSaldo);
        } else {
            luoTyhjaVarasto(tilavuus, alkuSaldo);
        }
    }

    private void luoVarasto(double tilavuus, double alkuSaldo) {
        this.tilavuus = tilavuus;
    ...
    private void luoTyhjaVarasto(double tilavuus, double alkuSaldo) {
        this.tilavuus = 0.0;
        this.saldo = 0.0;
    }
